...
namespace GotaSoundIO.Sound
{
    ...
    public class DspAdpcm : IAudioEncoding
    {
        ...
        public int SampleCount() => DspAdpcmMath.ByteCountToSampleCount(_data.Length);
        ...
        {
            _data = r.ReadBytes((int)(dataSize));
        }
        ...
        public void FromFloatPCM(float[] pcm, object encodingData = null, int loopStart = -1, int loopEnd = -1)
        {
            ...
            //Encode data.
            _data = DspAdpcmEncoder.EncodeSamples(s, context, loopStart);
        ...
        public float[] ToFloatPCM(object decodingData = null)
        {
            ...
            DspAdpcmDecoder.Decode(_data, ref pcm, ref Context, (uint)pcm.Length);
        ...
        {
            _data = _data.SubArray(0, DspAdpcmMath.SampleCountToByteCount(totalSamples));
        }
        ...
        {
            DspAdpcm ret = new() { _data = new byte[_data.Length] };
